    ...
    <ul class="nav nav-pills nav-stacked collapsed">
        ...
        <li role="presentation" class="active" >
            ...
            <ul class="nav nav-stacked">
                <li class="second-nav "><a href="administrator.php">Daftar Lokasi KKN</a></li>
                <!-- <li class="second-nav "><a href="inputsoal.php"></a></li>
                <li class="second-nav "><a href="tampilkansoal.php">Tampilkan Soal</a></li> -->
